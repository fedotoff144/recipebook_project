# Generated by Django 4.2.2 on 2024-10-27 18:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, upload_to='recipes_photo/', verbose_name='фото рецепта')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='recipebook.recipecategory')),
